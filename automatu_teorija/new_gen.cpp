...
///pos8
/*
if ((arr[9]==2 && arr[8]<2) or (arr[9]==2 && arr[8]==5))c[8]=c2[arr[8]];///ja (nak) pos ir"/0" un pats a vai b
else if(arr[9]<2 && arr[8]<5 && arr[7]<2)c[8]=c2[arr[8]];
//else if(arr[7]==5 && arr[8]==5)c[8]=c2[arr[8]];
else continue;*/
                c[8]=c2[arr[8]];
///pos9
                c[9]=c1[arr[9]];
