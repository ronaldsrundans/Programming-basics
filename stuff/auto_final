...
bool delta(string);///parejas funcijas deklaracija, kurai pados ievadito simboluvirkni
...
int main()
{
    ...
    do
    {
        ...
        cout << "Do you want to repeat-enter 1 or 0 to stop this program!" << endl;
        cin>>repeat;
        cout <<endl;
    }
    while(repeat==1);
...
{
///delta funkcija darbojas identiski XOR funkcijai - iespejami ir 4 (patiesiba ir 11-skatit zem delta fukcijas)dazadi stavokli
///(patiesiba starp 00un01 ir vel stavokli:00b un 00bb(,00un10,10un11,01un11 ir vel 2 apakstavoklie(skatit check_bbb un check_cbc):
...
///tatad sakuma stavoklis ir 00 un akceptejoso stavoklu kopa ir {01,10}.
